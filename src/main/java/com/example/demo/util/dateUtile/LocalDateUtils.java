...
public class LocalDateUtils {
    ...
    public static void main(String[] args) {
        System.out.println("========");
        System.out.println("获取当前日期和时间字符串:"+getLocalDateTimeStr());
        System.out.println("获取当前日期字符串:"+getLocalDateStr());
        System.out.println("获取当前时间字符串:"+getLocalTimeStr());
        System.out.println("获取当前星期字符串:"+getDayOfWeekStr());

        System.out.println("========");
        System.out.println("获取指定日期是星期几:"+getDayOfWeekStr(LocalDate.now()));
        System.out.println("LocalDate->字符串:"+format(LocalDate.now(), UNSIGNED_DATE_PATTERN));
        System.out.println("LocalDate->字符串:"+format(LocalDateTime.now(), DATETIME_PATTERN));
        System.out.println("LocalDate->字符串:"+format(LocalDateTime.now(), UNSIGNED_DATETIME_PATTERN));

        System.out.println("========");
        System.out.println("字符串->LocalDate:"+parseLocalDateTime("2020-12-13 11:14:12", DATETIME_PATTERN));
        System.out.println("字符串->LocalDate:"+parseLocalDate("2020-12-13", DATE_PATTERN));

        System.out.println("========");
        System.out.println("日期+日期:"+plus(LocalDateTime.now(), 3, ChronoUnit.HOURS));
        System.out.println("日期-日期:"+minus(LocalDateTime.now(), 4, ChronoUnit.DAYS));

        System.out.println("========");
        System.out.println("日期之间的间隔时长:"+getChronoUnitBetween(LocalDateTime.now(), parseLocalDateTime("2020-12-12 12:03:12", DATETIME_PATTERN), ChronoUnit.MINUTES));
        System.out.println("日期之间的间隔时长:"+getChronoUnitBetween(LocalDate.now(), parseLocalDate("2020-12-12", DATE_PATTERN), ChronoUnit.DAYS));

        System.out.println("========");
        System.out.println("本年第一天的日期->字符串:"+getFirstDayOfYearStr());
        System.out.println("指定年第一天的日期->字符串:"+getFirstDayOfYearStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定年第一天的日期->字符串:"+getFirstDayOfYearStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("本年最后一天的日期->字符串:"+getLastDayOfYearStr());
        System.out.println("指定年最后一天的日期->字符串:"+getLastDayOfYearStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定年最后一天的日期->字符串:"+getLastDayOfYearStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("========");
        System.out.println("本月第一天的日期->字符串:"+getFirstDayOfMonthStr());
        System.out.println("指定月第一天的日期->字符串:"+getFirstDayOfMonthStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定月第一天的日期->字符串:"+getFirstDayOfMonthStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("本月最后一天的日期->字符串:"+getLastDayOfMonthStr());
        System.out.println("指定月最后一天的日期->字符串:"+getLastDayOfMonthStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定月最后一天的日期->字符串:"+getLastDayOfMonthStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("========");
        System.out.println("本周第一天的日期->字符串:"+getFirstDayOfWeekStr());
        System.out.println("指定周第一天的日期->字符串:"+getFirstDayOfWeekStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定周第一天的日期->字符串:"+getFirstDayOfWeekStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("本周最后一天的日期->字符串:"+getLastDayOfWeekStr());
        System.out.println("指定周最后一天的日期->字符串:"+getLastDayOfWeekStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定周最后一天的日期->字符串:"+getLastDayOfWeekStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("========");
        System.out.println("本日开始的日期->字符串:"+getStartTimeOfDayStr());
        System.out.println("指定日开始的日期->字符串:"+getStartTimeOfDayStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定日开始的日期->字符串:"+getStartTimeOfDayStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("本日结束的日期->字符串:"+getEndTimeOfDayStr());
        System.out.println("指定日结束的日期->字符串:"+getEndTimeOfDayStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN)));
        System.out.println("指定日结束的日期->字符串:"+getEndTimeOfDayStr(parseLocalDateTime("2021-12-12 12:03:12", DATETIME_PATTERN), UNSIGNED_DATETIME_PATTERN));

        System.out.println("========");
        System.out.println("按照周期切割成小段日期段->按年切割:");
        ...
        System.out.println("========");
        System.out.println("按照周期切割成小段日期段->按月切割:");
        ...
        System.out.println("========");
        System.out.println("按照周期切割成小段日期段->按天切割:");
